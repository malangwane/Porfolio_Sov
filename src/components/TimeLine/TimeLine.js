...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        Hii, My name is Wiseman Malangwane a passionate webapps developer. I reside in Joburg North in Randburg(ferndale), I studied Bsc Infromation Technology majoring with Computer Science and Business Management and completed in December 2021. With love for tech and innovative tech like AI tech are one of my interests. 
      </SectionText>
      <SectionText>
